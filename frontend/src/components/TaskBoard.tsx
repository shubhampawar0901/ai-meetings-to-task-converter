        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {tasks.length} {tasks.length === 1 ? 'task' : 'tasks'} extracted from meeting transcript
            </p>
          </div>
        </div>
      ...
      {tasks.length === 0 && !isLoading && (
        <div className="text-center py-16">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No tasks extracted yet</h3>
            <p className="text-gray-500 mb-6">
              Paste a meeting transcript above to automatically extract and organize tasks from your meetings.
            </p>
      ...
      {isLoading && (
        <div className="text-center py-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-violet-100 to-purple-100 rounded-xl">
            ...
            <span className="text-violet-700 font-medium">Extracting tasks from meeting...</span>
          </div>
        </div>
      )}
    </div>
